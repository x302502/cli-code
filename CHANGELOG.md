...
- New: Shift+Enter newline, in-terminal search, font zoom, restart chip, OSC 52 clipboard, Cmd/Ctrl-click on links and file paths, copy context, quick commands, resume past sessions.
