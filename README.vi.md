...
Sao chép, Dán, Chọn tất cả, Sao chép ngữ cảnh, Xoá phiên (gõ `/clear` hoặc `/new` của CLI và xoá màn hình), Đổi tên tab, Khởi động lại phiên, Tìm trong terminal, Mở lại phiên cũ, Lệnh nhanh.

### Lệnh Command Palette

`CLI Code:` **Mở lại phiên cũ**, **Lệnh nhanh**, **Lưu thành lệnh nhanh**, **Đổi tên tab**, **Khởi động lại phiên**, **Xoá phiên**, **Phóng to chữ**, **Thu nhỏ chữ**, **Cỡ chữ mặc định**, **Tìm trong terminal**, **Sao chép ngữ cảnh**, **Dán**, **Sao chép**, **Cài hook trạng thái Claude**, **Gỡ hook trạng thái Claude**.
